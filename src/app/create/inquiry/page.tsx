          ...
          <div className="px-[24px] mt-[34px]">
            <div>
              ...
              <TextareaAutosize
                ...
                className="w-[100%] min-h-[132px] overflow-y-hidden px-[8px] py-[16px] mt-[8px] placeholder:text-body3 placeholder:text-grey-02 border-y-[1px] focus:outline-none focus:ring-0 rounded-none"
